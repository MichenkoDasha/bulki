<template>
  <q-page-container class="q-ml-xl q-mr-xl">
    <h5 class="text-center">Политика в отношении обработки персональных данных</h5>
    <div class="justify-center text-justify">
      <ol>
        <li> Общие положения
          ...
          и меры по обеспечению безопасности персональных данных, предпринимаемые "Булки.Онлайн" (далее – Оператор).
          <ol>
            <li>
            ...
            <li>
              ...
              ко всей информации, которую Оператор может получить о посетителях веб-сайта https://bulki.online
            </li>
          </ol>
        </li>
        <li> Основные понятия, используемые в Политике
          <ol>
            ...
            <li>
              ...
              обеспечивающих их доступность в сети интернет по сетевому адресу https://bulki.online;
            </li>
            <li>
            ...
            <li>
              ...
              определяемому Пользователю веб-сайта https://bulki.online;
            </li>
            <li>
              Пользователь – любой посетитель веб-сайта https://bulki.online;
            </li>
            <li>
        ...
        <li> Оператор может обрабатывать следующие персональные данные Пользователя
          <ol>
            ...
            <li>Cведения о доходах;</li>
            <li>Сведения о задолженности;</li>
            <li>Данные паспорта РФ;</li>
            <li>Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie»)
        ...
        <li> Цели обработки персональных данных
          <ol>
            ...
            <li>
              ...
              сообщений, направив Оператору письмо на адрес электронной почты urkovad0@gmail.com с пометкой «Отказ от
        ...
        <li> Правовые основания обработки персональных данных
          <ol>
            <li>
              ...
              Пользователем самостоятельно через специальные формы, расположенные на сайте https://bulki.online.
        ...
        <li> Порядок сбора, хранения, передачи и других видов обработки персональных данных
          ...
          <ol>
            <li>
              Оператор обеспечивает сохранность персональных данных и принимает все возможные меры, исключающие доступ
            ...
            <li>
              ...
              самостоятельно, путем направления Оператору уведомление на адрес электронной почты urkovad0@gmail.com
            ...
            <li>
              ...
              почты на электронный адрес Оператора urkovad0@gmail.com с пометкой
        ...
        <li> Заключительные положения
          <ol>
            <li>
              ...
              персональных данных, обратившись к Оператору с помощью электронной почты urkovad0@gmail.com
            </li>
            <li>
            ...
            <li>
              ...
              Интернет по адресу https://bulki.online/#/privacy
            </li>
          </ol>
        </li>
      </ol>
